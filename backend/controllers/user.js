...
exports.signup = async (req, res, next) => {
    try {
        ...
        await mysql.query('INSERT INTO user (`email`, `password`) VALUES (?, ?);', [req.body.email, hash]);
...
exports.login = async (req, res, next) => {
    try {
        const [user, user_fields] = await mysql.query('SELECT * FROM user WHERE email = ?;', [req.body.email]);
